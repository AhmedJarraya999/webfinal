...
{% block captcha_widget %}
    {% spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endspaceless %}
{% endblock %}", "@Captcha/captcha.html.twig", "C:\\Users\\jaray\\3D Objects\\codenameone\\jarrayasymfo-main\\vendor\\captcha-com\\symfony-captcha-bundle\\Resources\\views\\captcha.html.twig");
    }
}
