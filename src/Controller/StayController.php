...
class StayController extends AbstractController
{
  ...
  public function ajouter(Request $request, SerializerInterface $serializer)
  {
    ...
    $json = $serializer->serialize(
      $stay,
      'json',
      ['groups' => ['stays' /* if you add "user_detail" here you get circular reference */]]
    );
   ...
   */
  public function modifier(Request $request, $id, StayRepository $repo, SerializerInterface $serializer)
  {
